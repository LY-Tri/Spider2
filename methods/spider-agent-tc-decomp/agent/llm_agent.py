...
class LLMAgent:
    ...
    def call_llm(self, messages, instance_id=None, round_num=None):
        ...
        while retry_count < max_retries:
            try:
                if "max_tokens" in self.model_client.chat.completions.create.__code__.co_varnames and "temperature" in self.model_client.chat.completions.create.__code__.co_varnames:
